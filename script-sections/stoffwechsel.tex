...
\subsubsection{Glykolyse (EMP)}
\begin{itemize}
	\item Ausgeglichene Oxidations-Reduktions-Reaktion
	\item Knotenpunkt Pyruvat, von dem alle weiteren Fermentationsprodukte gebildet werden
\end{itemize}

\begin{enumerate}
	\item Stufe: Vorbereitende Reaktion
	\item Stufe: Synthese von ATP und Pyruvat
	\item Sutfe: Bildung von Fermentationsprodukten
\end{enumerate}
